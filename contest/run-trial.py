...
def run_datagrump(sender, receiver):
    ...
    receiver.sendCmd('/home/ravinet/mininet/mininet/datagrump/datagrump-receiver 9000 >/tmp/receiver-stdout 2>/tmp/receiver-stderr &')
    receiver.waitOutput()
    print "done."
    print "Running datagrump-sender...",
    sender.sendCmd('/home/ravinet/mininet/mininet/datagrump/datagrump-sender 10.0.1.2 9000 debug >/tmp/sender-stdout 2>/tmp/sender-stderr &')
    sender.waitOutput()
    print "done."
